...
`/quote/verify` 에서 라이브 확인. 현재 KSM 베이스라인 기준:

| 공정 | §3.5 자재 | 계산 | 달성률 |
|------|----------:|----:|------:|
| 1. 기초공사 | 4.73M | 4.20M | 89% |
| 2. 철골자재 | 67.08M | 55.47M | 83% |
| 3. 부속자재 | 24.39M | 7.97M | 33% |
| 4. 피복공사 | 23.35M | 16.40M | 70% |
| 5. 차광망 | 6.32M | 4.80M | 76% |
| 6. 보온커튼 | 5.54M | 5.14M | 93% |
| 7. 측면수직커튼 | 5.59M | **5.59M** | **100%** |
| 8. 전후면수직커튼 | 1.81M | **1.81M** | **100%** |
| 10. 개폐·환기 | 5.89M | 6.00M | 102% |
| 11. 콘트롤박스 | 5.15M | **5.15M** | **100%** |
| **합계** | 149.85M | 112.54M | **75%** |

수직커튼 단가는 §3.5 anchor 에서 역산 (7,280 / 6,464 원/㎡) — 시장 가격대(인슐레이팅 4겹) 일치.
부속자재(33%) · 철골(83%) 잔여 갭은 미수록 부재(도리·소형 부속·연결구 등) 때문.
