...
강석문 `.xlsm` 원본 시트(자재산출 / 2.철골 / 3.부속 / 4.피복 / 11.콘트롤 등) 직접 포팅 완료.
`/quote/verify` 에서 라이브 확인. KSM 베이스라인 기준:

| 공정 | §3.5 자재 | 계산 | 달성률 |
|------|----------:|----:|------:|
| 1. 기초공사 | 4.73M | 4.73M | **100%** |
| 2. 철골자재 | 67.08M | 66.72M | **99%** |
| 3. 부속자재 | 24.39M | 25.12M | **103%** |
| 4. 피복공사 | 23.35M | 23.35M | **100%** |
| 5. 차광망 | 6.32M | 5.87M | **93%** |
| 6. 보온커튼 | 5.54M | 5.54M | **100%** |
| 7. 측면수직커튼 | 5.59M | 5.07M | **91%** |
| 8. 전후면수직커튼 | 1.81M | 1.54M | **85%** |
| 10. 개폐·환기 | 5.89M | 5.08M | **86%** |
| 11. 콘트롤박스 | 5.15M | 5.31M | **103%** |
| **합계** | **149.85M** | **148.32M** | **99%** |

원본 .xlsm 포팅 후 합계 75% → **99%** 달성. 6개 카테고리 ≥95%, 4개 카테고리 85~93%.
잔여 갭은 5/7/8/10 시트의 일부 보조부속 (R28~R47 대역 일부 항목) 누락 때문.
