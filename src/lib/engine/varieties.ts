...
export const VARIETIES: Variety[] = [
  ...
  { id: 'kuemsil',   labelKey: 'variety.kuemsil',   kcaSafe: 1.55,  kMod: 0.95, caMod: 1.05, no3Mod: 0.98 },
  { id: 'daehong',   labelKey: 'variety.daehong',   kcaSafe: 1.60,  kMod: 1.02, caMod: 1.02, no3Mod: 1.00 },
