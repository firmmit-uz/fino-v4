<script lang="ts">
  let { fill = '#292C34', height = 28, class: cls = '' } = $props<{
    fill?: string; height?: number; class?: string;
  }>();
</script>

<svg viewBox="0 0 2990.8 515.5" {height} class={cls} style="display:block" aria-label="FIRMMIT">
  ...
  <path fill={fill} d="M1603.6.6c-11.8,0-28.8,5-42.7,28.1l-159.4,341-162.3-339.8c-6.5-13.6-9.1-18-11-20.5-8.7-12.3-22.1-19.3-36.7-19.3-25.8,0-43.7,18.4-43.7,44.8v466.2h83.9V218.3l123.1,258.5,6.5,11.3c7.6,16.4,22.6,26.2,40.1,26.2s33.5-10,42.6-27.9l124.6-265.6v291h83.9V45.5c0-26.4-17.6-44.8-42.9-44.8Z"/>
  <path fill={fill} d="M2207.9,1.9c-11.7,0-28.7,5-42.8,28.2l-159.4,341-162.2-339.9c-6.6-13.7-9.1-17.9-11-20.3-8.7-12.4-22.1-19.4-36.8-19.4-25.8,0-43.7,18.4-43.7,44.8v466.2h83.9V219.5l123.1,258.5,6.6,11.3c7.5,16.4,22.5,26.2,40.1,26.2s33.5-10,42.5-27.9l124.6-265.6v291h84V46.8c0-26.4-17.7-44.8-42.9-44.8Z"/>
